                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                ...
                                <li>
                                    <a href="#"><i class="fas fa-trash fa-fw"></i>Delete Role</a>
                                </li>
                                <li>
                                        ...
                                        <form action="deletebkey" method="post" class="">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="deletekey" name="deletekey" placeholder="Enter Role ID/ Role Type" class="form-control" required="required">
                                                </div>
                                            </div>
                                            <div class="form-actions form-group">
                                                <button type="submit" class="btn btn-primary btn-sm">Delete Role</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
