...
<head>
    ...
    <!-- Title Page-->
    <title>Cable Service Management System</title>
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li>
                            <a href="customerpack.jsp">
                                <i class="far fa-desktop"></i>Allocate Pack</a>
                        </li>
                        <li>
                ...
                <div class="section__content section__content--p30">
                    ...
                    <%
						...
						{ 
							...
							PreparedStatement ps = con.prepareStatement("SELECT u.user_name, u.mobile_no, u.name, u.email, u.address, a.area_name, r.role_type FROM `user` u JOIN `role` r ON u.role=r.role_id JOIN `area` a ON u.area_code=a.area_id WHERE u.deleted IS NULL AND u.user_id=?");
							ps.setInt(1, user);
