                            ...
                            <div class="col-lg-9">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                                        ...
                                        <h3>    <i class="fas fa-edit"></i>Edit Pack</h3>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="EditPack" method="post" class="">
                                        <%
                                            ...
                                            try
                                            {
                                                ...
                                                PreparedStatement ps = con.prepareStatement("SELECT pack_id, pack_name, duration, description, cost, remark FROM pack WHERE pack_name=? OR pack_id=? AND deleted IS NULL");
                                        ...
                                        %>
                                            <div class="form-group">
                                                <label for="packid" class="form-control-label">Pack ID</label><br>
                                                <input type="text" id="packid" name="packid" class="form-control" placeholder="Enter Pack ID" required="required" readonly="readonly" value="<%=pack_id%>">
                                            </div>
                                            <div class="form-group">
                                                <label for="packname" class="form-control-label">Pack Name</label><br>
                                                <input type="text" id="packname" name="packname" class="form-control" placeholder="Enter Pack Name" required="required" value="<%=packname%>">
                                            </div>
                                            <div class="form-group">
                                                <label for="duration" class="form-control-label">Duration</label><br>
                                                <input type="text" id="duration" name="duration" placeholder="Enter Duration of the Pack" class="form-control" required="required" value="<%=duration%>">
                                            </div>
                                            <div class="form-group">
	                                            <label for="description" class="form-control-label">Description</label><br>
	                                            <input type="text" id="description" name="description" placeholder="Enter Description of the Pack" class="form-control" required="required" value="<%=descp%>">
                                            </div>
                                            <div class="form-group">
	                                            <label for="description" class="form-control-label">Price</label><br>
	                                            <input type="text" id="cost" name="cost" placeholder="Enter Cost of the Pack" class="form-control" required="required" value="<%=cost%>">
                                            </div>
                                            <div class="form-group">
                                                <label for="remark" class="form-control-label">Remark</label><br>
