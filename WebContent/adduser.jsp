                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="#"><i class="fas fa-plus fa-fw"></i>Add User</a>
                                </li>
                                <li>
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    ...
                    <%
                    	...
                    	{
                    		out.println("<div class='sufee-alert alert with-close alert-primary alert-dismissible fade show'><span class='badge badge-pill badge-primary'>Success</span>One user added with Username "+request.getAttribute("user")+
                            ...
                            <div class="col-lg-9">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                                        ...
                                        <h3><i class="fas fa-plus"></i>Add User</h3>
                                    </div>
                                        ...
                                        <form action="adduser" method="post" class="">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="password" id="pass" name="pass" placeholder="Enter Password" class="form-control" required="required">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="password" id="c_pass" name="c_pass" placeholder="Confirm Password" class="form-control" required="required">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="name" name="name" placeholder="Enter Name" class="form-control" required="required">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="mobno" name="mobno" placeholder="Enter Mobile No." class="form-control" required="required">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <select name="area" id="area" class="form-control" required="required">
                                                        <option value="0" selected="selected" disabled="disabled">Select Area</option>
                                                        <%
                                                        	try 
                                                        	{
                                                    ...
                                                    <select name="role" id="role" class="form-control" required="Required">
                                                        ...
                                                        <%
                                                        	try 
                                                        	{
	                                                        	...
	                                                        	PreparedStatement ps1 = con1.prepareStatement("SELECT role_id, role_type FROM role WHERE deleted IS NULL");
                                                        	...
                                                        	{
                                                        		out.println("error loading packs");
                                                        	}
                                                       %>
                                                    </select>
                                                </div>
