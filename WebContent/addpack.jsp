                ...
                <div class="container-fluid">
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="#"><i class="fas fa-plus fa-fw"></i>Add Pack</a>
                                </li>
                                <li>
        ...
        <div class="page-container">
            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                    <%
                    	if(request.getAttribute("pack") != null)
                    	{
                    		out.println("<div class='sufee-alert alert with-close alert-primary alert-dismissible fade show'><span class='badge badge-pill badge-primary'>Success</span>One pack details added with pack name "+request.getAttribute("pack")+
                            ...
                            <div class="col-lg-9">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                                        ...
                                        <h3><i class="far fa-plus"></i>Add Pack</h3>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="addpack" method="post" class="">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <div class="input-group-addon">
                                                        <i class="fa fa-question fa-fw"></i>
                                                    </div>
                                                    <input type="text" id="npack" name="npack" placeholder="Enter Pack Name" class="form-control" required="required">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="dur" name="dur" placeholder="Enter Duration in Days" class="form-control" required="required">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="descp" name="descp" placeholder="Description of the pack" class="form-control" required="required">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <div class="input-group-addon">
                                                        <i class="far fa-rupee-sign fa-fw"></i>
                                                    </div>
                                                    <input type="text" id="cost" name="cost" placeholder="Cost of the pack" class="form-control" required="required">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
                                            ...
                                            <div class="form-actions form-group">
                                                <button type="submit" class="btn btn-primary btn-sm">Add Pack</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
