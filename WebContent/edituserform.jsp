                            ...
                            <div class="col-lg-9">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                                        ...
                                        <h3>    <i class="zmdi zmdi-edit"></i>Edit User</h3>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="edituser" method="post" class="">
                                        <%
                                            ...
                                            try
                                            {
                                                ...
                                                PreparedStatement ps = con.prepareStatement("SELECT u.mobile_no, u.remark, u.name, u.email, u.address, a.area_name, r.role_type, u.area_code, u.role FROM user u JOIN role r ON u.role=r.role_id JOIN area a ON u.area_code=a.area_id WHERE u.user_name=? OR u.mobile_no=? OR u.email=? AND u.status=? AND u.deleted IS NULL");
                                        ...
                                        %>
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="email" id="email" name="email" class="form-control" required="required" value="<%=email%>" placeholder="Enter Email">
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <select name="area" id="area" class="form-control" required="required">
                                                        ...
                                                        <%
                                                        	...
                                                        	PreparedStatement ps1 = con1.prepareStatement("SELECT area_id, area_name FROM area WHERE deleted IS NULL AND NOT area_id=?");
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <select name="role" id="role" class="form-control" required="required">
                                                        ...
                                                        <%
                                                        	try {
                                                        	Class.forName("com.mysql.jdbc.Driver");
                                                        	Connection con2 = DriverManager.getConnection("jdbc:mysql://localhost:3306/csms",dbuser,dbpass);
                                                        	PreparedStatement ps2 = con2.prepareStatement("SELECT role_id, role_type FROM role WHERE deleted IS NULL AND NOT role_id=?");
                                                        	ps2.setInt(1, role_id);
