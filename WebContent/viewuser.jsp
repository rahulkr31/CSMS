                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                ...
                                <li>
                                    <a href="#"><i class="fas fa-search fa-fw"></i>View User</a>
                                </li>
                                <li>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                        	<div class="form-header">
                                <input class="au-input au-input--xl" type="text" name="search" id="myInput" onkeyup="myFunction()" placeholder="Search for Role types...." />
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
										...
										<%
											...
											try
											{
												...
												PreparedStatement ps = con.prepareStatement("SELECT u.user_id, u.user_name, u.name, u.mobile_no, u.email, u.address, a.area_name, r.role_type, uc.name, u.created_on, up.name, u.updated_on, u.remark FROM user u JOIN role r ON u.role=r.role_id JOIN area a ON u.area_code=a.area_id JOIN user uc ON u.created_by=uc.user_id JOIN user up ON u.updated_by=up.user_id WHERE u.deleted IS NULL");
												...
												while(rs.next())
												{
													out.println("<tr><td>"+rs.getInt(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getString(3)+"</td><td>"+rs.getString(4)+
															    ...
															    "</td><td>"+rs.getString(13)+"</td><td>"+rs.getString(14)+"</td></tr>");
												}
												con.close();
											}
											catch(Exception e)
