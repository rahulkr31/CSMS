                                    ...
                                    <table class="table table-borderless table-striped table-earning">
										...
										<%
											...
											try
											{
												...
												PreparedStatement ps = con.prepareStatement("SELECT r.role_id, r.role_type, r.remark, u.name, r.created_on, up.name, r.updated_on FROM role r JOIN user u ON r.created_by = u.user_id JOIN user up ON r.updated_by = up.user_id WHERE r.deleted IS NULL");
