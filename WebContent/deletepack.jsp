                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                ...
                                <li>
                                    <a href="#"><i class="fas fa-trash fa-fw"></i>Delete Pack</a>
                                </li>
                                <li>
                            ...
                            <div class="col-lg-9">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                                        ...
                                        <h3><i class="far fa-trash"></i>Delete Pack</h3>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="deletebkey" method="post" class="">
                                        
                                        	<input type="hidden" name="page" value="pack">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="deletekey" name="deletekey" placeholder="Enter Pack ID/ Pack Name" class="form-control" required="required">
                                                </div>
                                            </div>
                                            <div class="form-actions form-group">
                                                <button type="submit" class="btn btn-primary btn-sm">Delete Pack</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
