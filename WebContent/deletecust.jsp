                            ...
                            <div class="col-lg-9">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="deletecust" method="post" class="">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="deletekey" name="deletekey" placeholder="Enter Mobile No./ Setupbox Id/ VC No." class="form-control" required="required">
                                                </div>
                                            </div>
                                            <div class="form-actions form-group">
                                                <button type="submit" class="btn btn-primary btn-sm">Delete Customer</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
