            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    ...
                    <%
                    	...
                    	{
                    		out.println("<div class='sufee-alert alert with-close alert-primary alert-dismissible fade show'><span class='badge badge-pill badge-primary'>Success</span>One customer updated with name "+request.getAttribute("consumer")+
                            ...
                            <div class="col-lg-9">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="editcustform.jsp" method="post" class="">
