                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                ...
                                <li>
                                    <a href="#"><i class="fas fa-edit fa-fw"></i>Edit Role</a>
                                </li>
                                <li>
                            ...
                            <div class="col-lg-9">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    ...
                                    <div class="card-body card-block">
                                        <form action="editroleform.jsp" method="post" class="">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    <div class="input-group-addon">
                                                        <i class="fa fa-search fa-fw"></i>
                                                    </div>
                                                    <input type="text" id="search_id" name="search_id" placeholder="Enter Role ID/ Role Type" class="form-control" required="required">
                                                </div>
                                            </div>
