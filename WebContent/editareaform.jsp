                            ...
                            <div class="col-lg-9">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                                        ...
                                        <h3>    <i class="fas fa-edit"></i>Edit Area</h3>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="EditArea" method="post" class="">
                                        <%
                                            ...
                                            try
                                            {
                                                ...
                                                PreparedStatement ps = con.prepareStatement("SELECT area_id, area_name, remark FROM area WHERE area_name=? OR area_id=? AND deleted IS NULL");
                                        ...
                                        %>
                                            <div class="form-group">
	                                            <label for="areaid" class=" form-control-label">Area ID</label>
	                                            <input type="text" id="areaid" name="areaid" class="form-control" placeholder="Enter AreaID" required="required" readonly="readonly" value="<%=area_id %>">
                                            </div>
                                            <div class="form-group">
                                                <label for="areaname" class=" form-control-label">Area Name</label>
                                                <input type="text" id="areaname" name="areaname" class="form-control" placeholder="Enter Area Name" required="required" value="<%=area_name %>">
                                            </div>
                                            <div class="form-group">
                                                <label for="remark" class=" form-control-label">Remark(if any)</label>
                                                <input type="text" id="remark" name="remark" placeholder="Remarks(if any)" class="form-control" value="<%=remark %> ">
                                            </div>
                                            <div class="form-actions form-group">
                                                <button type="submit" class="btn btn-primary btn-sm">Update Area</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
