                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                ...
                                <li>
                                    <a href="#"><i class="fas fa-search fa-fw"></i>View Pack</a>
                                </li>
                                <li>
                    ...
                    <div class="container-fluid">
                        <div class="header-wrap">
                        	<div class="form-header">
                                <input class="au-input au-input--xl" type="text" name="search" id="myInput" onkeyup="myFunction()" placeholder="Search for Pack names..." />
                                    ...
                                    <table class="table table-borderless table-striped table-earning">
										...
										<%
											...
											try
											{
												...
												PreparedStatement ps = con.prepareStatement("SELECT p.pack_id, p.pack_name, p.duration, p.description, p.cost, p.remark, u.name, p.created_on, up.name, p.updated_on FROM pack p JOIN user u ON p.created_by = u.user_id JOIN user up ON p.updated_by = up.user_id WHERE p.deleted IS NULL");

												ResultSet rs = ps.executeQuery();
												while(rs.next())
												{
													out.println("<tr><td>"+rs.getInt(1)+"</td><td>"+rs.getString(2)+"</td><td>"+rs.getInt(3)+
															"</td><td>"+rs.getString(4)+"</td><td>"+rs.getInt(3)+"</td><td>"+rs.getString(5)+"</td><td>"+rs.getString(6)+
															"</td><td>"+rs.getString(7)+"</td><td>"+rs.getString(8)+"</td><td>"+rs.getString(9)+"</td></tr>");
												}
												con.close();
											}
											catch(Exception e)
