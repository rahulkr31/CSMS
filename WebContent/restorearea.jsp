                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                ...
                                <li>
                                    <a href="#"><i class="fas fa-redo fa-fw"></i>Restore Area</a>
                                </li>
                            </ul>
                        </li>
                        <li class="has-sub">
                            ...
                            <div class="col-lg-9">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                                        ...
                                        <h3><i class="fas fa-redo"></i>Restore Area</h3>
                                    </div>
                                        ...
                                        <form action="restore" method="post" class="">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="restorekey" name="restorekey" placeholder="Enter Area ID/ Area Name" class="form-control" required="required">
                                                </div>
                                            </div>
                                            <div class="form-actions form-group">
                                                <button type="submit" class="btn btn-primary btn-sm">Restore Area</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
