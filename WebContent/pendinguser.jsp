            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    ...
                    %>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h3 class="title-5 m-b-35"><i class="fas fa-bullseye"></i>Pending Users</h3>
                                    ...
                                    <table class="table table-data2">
                                        ...
                                        <%
                                            ...
                                            try
                                            {
                                                ...
                                                PreparedStatement ps = con.prepareStatement("SELECT u.user_id, u.user_name, u.name, u.mobile_no, r.role_type FROM user u JOIN role r ON u.role = r.role_id WHERE u.status=? AND u.deleted IS NULL");
                                                ps.setInt(1, 0);
                                                ResultSet rs = ps.executeQuery();
                                                while(rs.next())
                                                {
                                                    out.println("<tr class='tr-shadow'><td class='desc'>"+rs.getString(2)+"</td><td>"+rs.getString(3)+
                                                            "</td><td>"+rs.getString(4)+"</td><td>"+rs.getString(5)+"</td><td>");
                                                    out.println("<div class='table-data-feature'><form action='accept' method='post'><input type='hidden' name='userid' value="+rs.getInt(1)+
                                                            "><button type='submit' class='item' id='accept-btn' data-toggle='tooltip' data-placement='top' title='Accept'><i class='zmdi zmdi-check-all'></i></button></form>");
                                                    out.println("<form action='deleteuser' method='post'><input type='hidden' name='userid' value="+rs.getInt(1)+
                                                            "><button type='submit' id='delete-btn' class='item' data-toggle='tooltip' data-placement='top' title='Delete'><i class='zmdi zmdi-delete'></i></button></form></div></td></tr><tr class='spacer'></tr>");
                                                }
                                                con.close();
                                            }
                                            catch(Exception e)
