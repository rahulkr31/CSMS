                            ...
                            <div class="col-lg-9">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                                        ...
                                        <h3><i class="fas fa-redo"></i>Restore Customer</h3>
                                    </div>
                                    <div class="card-body card-block">
                                        <form action="restorecust" method="post" class="">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" id="restorekey" name="restorekey" placeholder="Enter Mobile No./ Setupbox Id/ VC No." class="form-control" required="required">
                                                </div>
                                            </div>
                                            <div class="form-actions form-group">
                                                <button type="submit" class="btn btn-primary btn-sm">Restore Customer</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
