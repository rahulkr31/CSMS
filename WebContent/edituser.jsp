                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        ...
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                ...
                                <li>
                                    <a href="#"><i class="fas fa-edit fa-fw"></i>Edit User</a>
                                </li>
                                <li>
                                        ...
                                        <form action="editcustform.jsp" method="post" class="">
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" name="search_id" id="search_id" class="form-control" placeholder="Enter UserName/ Mobile No./ Email" required="required" />
                                                </div>
                                            </div>
